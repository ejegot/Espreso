...
config :espreso, Espreso.Repo,
  username: "postgres",
  password: "postgres",
  hostname: "localhost",
  database: "espreso_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :espreso, EspresoWeb.Endpoint,
  ...
  secret_key_base: "ASqZUTSI162nDKoh0v2IG76nhVX/zWIBtSdTgK5OZTGy+NAWNKFrVraBuTqtVd/A",
  server: false

# In test we don't send emails
config :espreso, Espreso.Mailer, adapter: Swoosh.Adapters.Test
